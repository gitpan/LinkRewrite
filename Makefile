# This Makefile is for the LinkRewrite extension to perl.
#
...
AR_STATIC_ARGS = cr
NAME = LinkRewrite
DISTNAME = LinkRewrite
NAME_SYM = LinkRewrite
VERSION = 0.01
VERSION_SYM = 0_01
XS_VERSION = 0.01
INST_BIN = blib/bin
...
TO_INST_PM = LinkRewrite.pm

PM_TO_BLIB = LinkRewrite.pm \
	$(INST_LIBDIR)/LinkRewrite.pm
...
manifypods : pure_all LinkRewrite.pm
	@$(POD2MAN) \
	LinkRewrite.pm \
	$(INST_MAN3DIR)/LinkRewrite.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -f $(INST_LIBDIR)/LinkRewrite.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"LinkRewrite\" VERSION=\"0,01,0,0\">\n}. qq{\t<TITLE>LinkRewrite</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > LinkRewrite.ppd
